				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<div>
						...
						<div class="entry-content">
							...
							<div id="feed_area">
								<?php $loop = new WP_Query('author=2&cat=52&showposts=5');
								...
								<dl>
									...
									<dd><?php echo $img; ?><span class="article_title"><a href="<?php the_permalink(); ?>"><?php the_title_attribute(); ?> の記事を追加</a></span></dd>
