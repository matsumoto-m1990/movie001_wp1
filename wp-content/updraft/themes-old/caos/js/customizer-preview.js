...
( function( $ ) {
	...
	// Logo
	wp.customize( 'caos_logo', function( value ) {
		value.bind( function( to ) {
			if ( to != "" ) {
				var logo = '<img src="' + to + '" />';
    ...
    */
		//Featured Color
		wp.customize( 'caos_hero_color', function( value ) {
			value.bind( function( to ) {
		...
		//Text Color
		wp.customize( 'caos_text_color', function( value ) {
			value.bind( function( to ) {
				$( 'body' ).css( {
						'color': to
				} );
		...
		//Link Color
		wp.customize( 'caos_link_color', function( value ) {
			value.bind( function( to ) {
				$( 'a' ).css( {
						'color': to
				} );
