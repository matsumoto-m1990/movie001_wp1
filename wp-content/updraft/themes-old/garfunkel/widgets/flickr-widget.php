...
class garfunkel_flickr_widget extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array( 'classname' => 'garfunkel_flickr_widget', 'description' => __('Displays your latest Flickr photos.', 'garfunkel') );
        parent::__construct( 'garfunkel_flickr_widget', __('Flickr Widget','garfunkel'), $widget_ops );
    }
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('id')); ?>"><?php _e('Flickr ID (use <a target="_blank" href="http://www.idgettr.com">idGettr</a>)', 'garfunkel'); ?>:
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php _e('Number of images to display', 'garfunkel'); ?>:
