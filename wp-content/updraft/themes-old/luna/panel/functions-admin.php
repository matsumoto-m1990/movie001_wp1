<?php
/**
 * luna admin functions
 *
 * @package luna 
 */

// admin area styling
function luna_custom_colors() {
...
add_action('admin_head', 'luna_custom_colors'); 
...
add_action( 'tgmpa_register', 'luna_recommend_plugin' );
function luna_recommend_plugin() {
