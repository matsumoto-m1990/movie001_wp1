...
class luna_social extends WP_Widget {
	
	
// constructor

    function luna_social() {

		$widget_ops = array('classname' => 'luna_social_widget', 'description' => esc_html__( 'Drag this widget to the Social Widget Area.', 'luna') );

        parent::__construct(false, $name = esc_html__('MT - Social Icons', 'luna'), $widget_ops); 

		$this->alt_option_name = 'luna_social_widget';
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id( 'social_url_path' )); ?>"><?php esc_html_e( 'Check this box to open links in a new window.', 'luna' ); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_fb_link')); ?>"><?php esc_html_e('Facebook URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_twitter_link')); ?>"><?php esc_html_e('Twitter URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_linked_link')); ?>"><?php esc_html_e('LinkedIn URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_google_link')); ?>"><?php esc_html_e('Google URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_instagram_link')); ?>"><?php esc_html_e('Instagram URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_snapchat_link')); ?>"><?php esc_html_e('Snapchat URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vine_link')); ?>"><?php esc_html_e('Vine URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_flickr_link')); ?>"><?php esc_html_e('Flickr URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_pinterest_link')); ?>"><?php esc_html_e('Pinterest URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_youtube_link')); ?>"><?php esc_html_e('Youtube URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vimeo_link')); ?>"><?php esc_html_e('Vimeo URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_tumblr_link')); ?>"><?php esc_html_e('Tumblr URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_stumble_link')); ?>"><?php esc_html_e('StumbleUpon URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_dribbble_link')); ?>"><?php esc_html_e('Dribbble URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_yelp_link')); ?>"><?php esc_html_e('Yelp URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vk_link')); ?>"><?php esc_html_e('VK URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_xing_link')); ?>"><?php esc_html_e('Xing URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_deviant_link')); ?>"><?php esc_html_e('DeviantArt URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_500_link')); ?>"><?php esc_html_e('500px URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_behance_link')); ?>"><?php esc_html_e('Behance URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_lastfm_link')); ?>"><?php esc_html_e('lastFM URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_soundcloud_link')); ?>"><?php esc_html_e('SoundCloud URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_reddit_link')); ?>"><?php esc_html_e('Reddit URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_github_link')); ?>"><?php esc_html_e('Github URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_codepen_link')); ?>"><?php esc_html_e('CodePen URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_skype_link')); ?>"><?php esc_html_e('Skype URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_spotify_link')); ?>"><?php esc_html_e('Spotify URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_weibo_link')); ?>"><?php esc_html_e('Weibo URL:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_email_link')); ?>"><?php esc_html_e('Email Address:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_telephone_link')); ?>"><?php esc_html_e('Phone Number:', 'luna'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_rss_link')); ?>"><?php esc_html_e('RSS URL:', 'luna'); ?></label>
	...
	function update($new_instance, $old_instance) { 
		...
		if ( isset($alloptions['luna_social']) )

			delete_option('luna_social');		  
	...
	function flush_widget_cache() {
		...
		wp_cache_delete('luna_social', 'widget');
	...
	function widget($args, $instance) {
		...
		if ( ! $this->is_preview() ) {
			...
			$cache = wp_cache_get( 'luna_social', 'widget' );
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'luna_social', $cache, 'widget' ); 
