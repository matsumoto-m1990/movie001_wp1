 ...
 * Plugin URI:    http://mobioc.com/wordpress-ping-optimizer-plugin/
...
*/
	...
	function cbnetpoFooter() {
		echo '<p style="text-align:center;margin-top:3em;"><strong>'.cbnetpo_NAME.' '.cbnetpo_VERSION.' by <a href=" http://mobioc.com/" target="_blank" >mobioc.com</a></strong></p>';
	}
	...
	function cbnetpoFuturePing() {
		...
		if ( count($this->cbnetpo_future_pings) <= 0 || $this->cbnetpo_wp_version >= 2.4) {
			return true;
		}
